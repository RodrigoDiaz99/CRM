                        ...
                        <div class="divide-y divide-gray-200 ">
                            <form action="{{ route('inventory.update', $inventory->id)}}" enctype="multipart/form-data" method="PUT">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input oninput="salePriceCalculator()" value="{{$inventory->purchase_price}}" type="number" min="1" step="0.01" name="purchase_price" id="purchase_price" class="px-4 py-2 border focus:ring-gray-500 focus:border-green-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" placeholder="35" required autofocus>
                                </div>
                                <div class="flex flex-col">
                                    <label class="leading-loose text-blue-500 uppercase dark:text-primary-light">Margen ganancia %</label>
                                    <input oninput="salePriceCalculator()" value="{{$inventory->percent_of_profit}}" type="number" min="1" step="0.01" name="percent_of_profit" id="percent_of_profit" class="px-4 py-2 border focus:ring-gray-500 focus:border-green-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" placeholder="10" required autofocus>
                                </div>
                                <div class="flex flex-col">
                                    <label class="leading-loose text-blue-500 uppercase dark:text-primary-light">Precio venta</label>
                                    <input oninput="percentProfitCalculator()" value="{{$inventory->sale_price}}" type="number" min="1" step="0.01" name="sale_price" id="sale_price" class="px-4 py-2 border focus:ring-gray-500 focus:border-green-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" placeholder="38.5" required autofocus>
                                </div>
