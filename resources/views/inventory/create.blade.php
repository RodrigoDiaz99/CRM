                        ...
                        <div class="divide-y divide-gray-200 ">
                            <form action="{{ route('inventory.store') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="number" min="1" name="purchase_price" id="purchase_price" class="px-4 py-2 border focus:ring-gray-500 focus:border-green-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" placeholder="35" required autofocus>
                                </div>
                                <div class="flex flex-col">
