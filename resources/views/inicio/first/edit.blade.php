                    ...
                    <div class="max-w-md mx-auto">
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                                <h2 class="leading-relaxed text-blue-500 uppercase dark:text-primary-light">Banner 1
                                </h2>
                                <span class="leading-relaxed text-blue-500 uppercase dark:text-primary-light">Editar banner 1
                                </span>
                            </div>
                        </div>
                        <div class="divide-y divide-gray-200 ">
                            <form action="{{ route('update_one', $content1->id) }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
@method('PUT')
                                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    <div class="flex flex-col">
                                        <label
                                            ...
                                            del producto</label>
                                        <input value="{{ $content1->title }}" type="text" name="title" id="title"
                                    ...
                                    <div class="flex flex-col">
                                        <label
                                            ...
                                            producto</label>
                                        <input value="{{ $content1->description }}" type="text" name="description"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <img class="object-contain h-24 w-full"
                                            src="{{ Storage::url($content1->img_paths) }}" alt="$book->name">
                                        <input type="text" name="cover_delete" hidden
                                            value="{{ $content1->img_paths }}">
                                        <br>
                                        <!-- component -->
                                        <label
                                            ...
                                            <span id="coverRecive" class="mt-2 text-base leading-normal">SELECCIONE
                                                IMAGEN</span>
                                            <input type='file' id="cover_file" accept="image/png, image/jpeg, image/jpg"
                                                name="cover_file" class="hidden" />
                                        </label>
                                    </div>
                                </div>
