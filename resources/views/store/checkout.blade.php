                    ...
                    <div class="mt-8">
                        <div class="grid-cols-2">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="name">Nombre(s)</label>
                                <input class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" type="text" id="name" autofocus name="name">
                            </div>
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="last_name">Apellidos</label>
                                <input class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" type="text" id="last_name" name="last_name">
                            </div>


                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="phone">Celular</label>
                                <input class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" type="number" id="phone" name="phone">
                            </div>
                        </div>
                    </div>
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-3">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label for="state" class="block uppercase tracking-wide text-gray-700 font-bold mb-2">ESTADO/PROVINCIA/REGION
                                    <input type="text" onkeyup="mayus(this);" style="text-transform: uppercase;" class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" required id="state" name="state"></label>
                            </div>

                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label for="city" class="block uppercase tracking-wide text-gray-700 font-bold mb-2">MUNICIPIO/CIUDAD
                                    <input type="text" class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" placeholder="" id="city" name="city"></label>
                            </div>
                        </div>
                        <div class="mt-8">
                            <div class="grid grid-cols-3">
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="street">DIRECCION
                                        POSTAL/CALLE
                                        <input type="text" id="street" name="street" class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600">
                                    </label>
                                </div>
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="number_exterior">NUMERO
                                        EXTERIOR
                                        <input type="number" id="number_exterior" name="number_exterior" class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600">
                                    </label>
                                </div>
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="grid grid-cols-3">
                            <div class="w-full md:w-1/2 px-3 mb-3">
                                <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="suburb">COLONIA
                                    ...
                                    <input type="text" id="suburb" name="suburb" class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600">
                                </label>
                            </div>
                            <div class="w-full md:w-1/2 px-3 mb-3">
                                <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="zip">
                                    CODIGO POSTAL
                                    <input type="number" id="zip" name="zip" class="px-4 py-2 border focus:ring-gray-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600">
                                </label>
                            </div>
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-3">
                                <label class="block uppercase tracking-wide text-gray-700 font-bold mb-2" for="reference">
                                    REFERENCIA
                                    <textarea id="reference" name="reference" class="px-4 py-2 focus:ring-gray-500 w-full sm:text-sm border-blue-500 focus:outline-none text-gray-600 resize border rounded-md"></textarea>
                                </label>
                            </div>
